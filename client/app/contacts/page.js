export default function Contacts() {
  return (
    <>
      <div className="aboslute flex justify-center items-center w-screen h-screen/3 bg-stone-100">
        <div className="container mx-auto my-4 px-4 lg:px-20">
          <div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl bg-white">
            ...
            <div className="my-2 w-1/2 lg:w-1/4">
              <button
                className="uppercase text-sm font-bold tracking-wide bg-emerald-700 text-gray-100 p-3 rounded-lg w-full 
